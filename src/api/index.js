...
export const baseURL = 'https://node-auth-master.youmrabti.com'
...
export const currentUser = (token) => API.post('/users/current-user', {}, { headers: { Authorization: `Bearer ${token}` } })
